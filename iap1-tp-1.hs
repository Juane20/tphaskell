...
segundaRed = ([usuarioKevin, usuarioSofia, usuarioElias, usuarioAngel], [relacionE_A, relacionK_S], [publicacionE_1, publicacionK_1, publicacionS_existeSecuenciaDeAmigos :: RedSocial -> Usuario -> Usuario -> Bool
